...
export default function HistoryCity(){
    const data: DataType[] = [
        {
            title: 'Fundação',
            ...
            image: require('../assets/images/fundação.jpeg'),
            data: "14/09/1917",
        },
        {
            ...
            image: require('../assets/images/santuario-nossa-senhora.jpg'),
            data: "16/02/1968",
        },
        {
            ...
            image: require('../assets/images/unoeste.jpg'),
            data: "3/10/1972"
        },
        {
